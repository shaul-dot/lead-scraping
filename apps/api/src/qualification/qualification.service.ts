                ...
                try {
                  ...
                  const created = await prisma.knownAdvertiser.create({
                    data: {
                      ...
                      aiQualificationConfidence: out.confidence,
                      aiNiche: out.metadata?.niche ?? null,
                      aiSubNiche: out.metadata?.subNiche ?? null,
                      aiOfferingType: out.metadata?.offeringType ?? null,
                      aiSpecificOffering: out.metadata?.specificOffering ?? null,
                      aiUniqueAngle: out.metadata?.uniqueAngle ?? null,
                      aiSocialProof: out.metadata?.socialProof ?? null,
                      aiToneSignals: out.metadata?.toneSignals ?? null,
                    },
                    select: { id: true },
                  });
